                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                <li>
                                    <a class="active" href="#"><i class="fa fa-user-md fa-2x"></i><span class="sidebar-mini-hide">О нас</span></a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-university fa-2x"></i><span class="sidebar-mini-hide">Аптеки</span></a>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-vcard-o fa-2x"></i><span class="sidebar-mini-hide">Контакты</span></a>
                                </li>
