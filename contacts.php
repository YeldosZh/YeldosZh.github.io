                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="contacts.php"><i class="glyphicon glyphicon-user"></i><span class="sidebar-mini-hide">Контакты</span></a>
                                </li>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="block block-bordered">
                                        <div class="block-header">
                                            <h3 class="block-title">Наш Адрес</h3>
                                        </div>
                                        <div class="block-content block-content-full">
                                            <div class="h4 push-5">«Aika pharma»</div>
                                            <address>
                                                Казыбек би 117/1<br>
                                                Алматы, Казахстан 050000<br><br>
